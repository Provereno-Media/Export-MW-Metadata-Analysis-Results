Overview — this README is designed for GitHub first: strong visual header, badges, clear install/usage flow, polished tables, and a collapsible code block for the bookmarklet. It stays fully compatible with standard GitHub Markdown and keeps the project page clean and professional.
